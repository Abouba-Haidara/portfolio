                        ...
                        <nav id="navigation">
                            ...
                            <div class="nav-box navbar-collapse">
                                <ul class="navigation-menu nav navbar-nav navbars" id="nav">
                                    <li data-menuanchor="slide01" class="active"><a href="#slide01">Haidara</a></li>
                                    ...
                                    <li data-menuanchor="slide06"><a href="#slide06">Work Experiences</a></li>
                                    <li data-menuanchor="slide07"><a href="#slide07">Blog</a></li>
                                    <li data-menuanchor="slide08"><a href="#slide08">Contact Me</a></li>
                                                ...
                                                <div class="item animate" data-animate="fadeInUp">
                                                    <div class="counter-box">
                                                        <i class="fa fa-certificate counter-icon"
                                                            ...
                                                            <a href="https://drive.google.com/file/d/1k2HhCIAESOKNmjGo6NAMDYbxVdywIR3Q/view?usp=sharing"
                                ...
                                <div class="item animate" data-animate="fadeInUp">
                                        <div class="portfolio-item">
                                            ...
                                            <div class="thumb-inner animate" data-animate="fadeInUp">
                                                ...
                                                <p>
                                                   Dans cette application,Un Simple facebook cloe, j'ai utilisée REACTJS ET FIREBASE pour clonner facebook! <a target="_blank" href="https://simplefacebookclone.web.app/">VoirnDemo</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
